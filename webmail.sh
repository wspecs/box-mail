...
install_once dbconfig-common
install_once php$PHP_VERSION-cli
install_once php$PHP_VERSION-sqlite3
install_once php$PHP_VERSION-intl
install_once php$PHP_VERSION-json
install_once php$PHP_VERSION-common
install_once php$PHP_VERSION-curl
install_once php$PHP_VERSION-ldap
install_once php$PHP_VERSION-gd
install_once php$PHP_VERSION-pspell
install_once php$PHP_VERSION-mbstring
install_once tinymce
install_once libjs-jquery
install_once libjs-jquery-mousewheel
install_once libmagic1
...
<?php
/*
 * Do not edit. Written by wspecsbox. Regenerated on updates.
 */
\$config = array();
...
\$config['support_url'] = 'https://wspecsbox.email/';
...
edit_config ${RCM_PLUGIN_DIR}/password/config.inc.php \
