...
install_once php$PHP_VERSION-soap
install_once php$PHP_VERSION-imap
install_once php$PHP_VERSION-xsl
install_once libawl-php
...
cp zpush/backend_combined.php /usr/local/lib/z-push/backend/combined/config.php

# Configure IMAP
rm -f /usr/local/lib/z-push/backend/imap/config.php
cp zpush/backend_imap.php /usr/local/lib/z-push/backend/imap/config.php
...
cp zpush/backend_carddav.php /usr/local/lib/z-push/backend/carddav/config.php

# Configure CalDav
rm -f /usr/local/lib/z-push/backend/caldav/config.php
cp zpush/backend_caldav.php /usr/local/lib/z-push/backend/caldav/config.php

# Configure Autodiscover
rm -f /usr/local/lib/z-push/autodiscover/config.php
cp zpush/autodiscover_config.php /usr/local/lib/z-push/autodiscover/config.php
